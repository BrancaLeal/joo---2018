...
public class JogoDaVelha {
	...
	private void initialize() {
		...
		xPontos.setFont(new Font("Tahoma", Font.BOLD, 58));
		...
		lblO.setFont(new Font("Tahoma", Font.BOLD, 48));
		...
		oPontos.setFont(new Font("Tahoma", Font.BOLD, 58));
		...
		btnExit.setFont(new Font("Tahoma", Font.BOLD, 48));
		panel_15.add(btnExit, BorderLayout.CENTER);
	}
	
	// FIXME 1
	private void anularTextosDeBotao(final JButton botao) {
		botao.setText(null);
	}
	...
	private void conferirJogo() {
		...
		// Player 1
		if (b1.equalsIgnoreCase("X") && b2.equalsIgnoreCase("X") && 
				b3.equalsIgnoreCase("X")) {
			JOptionPane.showMessageDialog(frame, "Player 1 ganhou!", 
